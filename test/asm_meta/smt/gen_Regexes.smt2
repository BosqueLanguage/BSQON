...
(define-fun Main@main ((user Main@UserDTO)) (@Result Main@UserDTO)
    ...
    (let ((@tmpe-update_usr (ite (not (Main@UserDTO_$_invariant0 (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user))) ((as @Result-err (@Result Main@UserDTO)) @err-other) (ite (not (Main@UserDTO_$_invariant1 (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user))) ((as @Result-err (@Result Main@UserDTO)) @err-other) (ite (not (Main@UserDTO_$_invariant2 (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user))) ((as @Result-err (@Result Main@UserDTO)) @err-other) (ite (not (Main@UserDTO_$_invariant3 (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user))) ((as @Result-err (@Result Main@UserDTO)) @err-other) (ite (not (Main@UserDTO_$_invariant4 (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user))) ((as @Result-err (@Result Main@UserDTO)) @err-other) (@Result-ok (Main@UserDTO-mk (Main@UserDTO-email user) (Main@UserDTO-password james) (Main@UserDTO-name james) (Main@UserDTO-phone user) (Main@UserDTO-address user)))))))))) (ite (not (is-@Result-ok @tmpe-update_usr))  @tmpe-update_usr (let ((update_usr (@Result-value @tmpe-update_usr)))
        (@Result-ok update_usr)
    ))))))
)
