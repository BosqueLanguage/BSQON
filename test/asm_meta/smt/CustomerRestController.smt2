...
(define-fun Main@main ((user Main@UserDTO)) (@Result Main@UserDTO)
    (let ((@tmpe-james Main@getCustomer)) (ite (not (is-@Result-ok @tmpe-james))  @tmpe-james (let ((james (@Result-value @tmpe-james)))
        (ite (not (= (let ((@tmp-1-0 (ite (not (not (= (Main@UserDTO-name james) @Term-None-mk))) ((as @Result-err (@Result Main@USER_NAME)) @err-other) (@Result-ok (Some<Main@USER_NAME>-value (@Term-Some<Main@USER_NAME>-value (Main@UserDTO-name james))))))) (ite (not (is-@Result-ok @tmp-1-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-0)) (let ((@tmp-1-1 (ite (not (not (= (Main@UserDTO-name user) @Term-None-mk))) ((as @Result-err (@Result Main@USER_NAME)) @err-other) (@Result-ok (Some<Main@USER_NAME>-value (@Term-Some<Main@USER_NAME>-value (Main@UserDTO-name user))))))) (ite (not (is-@Result-ok @tmp-1-1)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-1)) (@Result-ok (not (= (@Result-value @tmp-1-0) (@Result-value @tmp-1-1)))))))) (@Result-ok true))) (let ((@failure (let ((@tmp-1-0 (ite (not (not (= (Main@UserDTO-name james) @Term-None-mk))) ((as @Result-err (@Result Main@USER_NAME)) @err-other) (@Result-ok (Some<Main@USER_NAME>-value (@Term-Some<Main@USER_NAME>-value (Main@UserDTO-name james))))))) (ite (not (is-@Result-ok @tmp-1-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-0)) (let ((@tmp-1-1 (ite (not (not (= (Main@UserDTO-name user) @Term-None-mk))) ((as @Result-err (@Result Main@USER_NAME)) @err-other) (@Result-ok (Some<Main@USER_NAME>-value (@Term-Some<Main@USER_NAME>-value (Main@UserDTO-name user))))))) (ite (not (is-@Result-ok @tmp-1-1)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-1)) (@Result-ok (not (= (@Result-value @tmp-1-0) (@Result-value @tmp-1-1)))))))))) (ite (= @failure (@Result-ok false)) ((as @Result-err (@Result Main@UserDTO)) @err-other) ((as @Result-err (@Result Main@UserDTO)) (@Result-etag @failure))))
            (@Result-ok user)
        )
    )))
)
