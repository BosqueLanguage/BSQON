...
(define-fun Main@main ((f List<Int>)) (@Result List<Int>)
    (ite (not (not (= (List<Int>@size f) 3))) ((as @Result-err (@Result List<Int>)) @err-other)
        (ite (not (= (let ((@tmp-4-0 (let ((@tmp-1-0 (ite (not (List<Int>@get_$_precond0 f 2)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 2))))) (ite (not (is-@Result-ok @tmp-1-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-0)) (@Result-ok (not (= (@Result-value @tmp-1-0) 7))))))) (ite (not (is-@Result-ok @tmp-4-0)) @tmp-4-0 (let ((@tmp-4-1 (let ((@tmp-2-0 (ite (not (List<Int>@get_$_precond0 f 0)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 0))))) (ite (not (is-@Result-ok @tmp-2-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-2-0)) (@Result-ok (not (= (@Result-value @tmp-2-0) 10))))))) (ite (not (is-@Result-ok @tmp-4-1)) @tmp-4-1 (let ((@tmp-4-2 (let ((@tmp-3-0 (ite (not (List<Int>@get_$_precond0 f 1)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 1))))) (ite (not (is-@Result-ok @tmp-3-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-3-0)) (@Result-ok (not (= (@Result-value @tmp-3-0) 2))))))) (ite (not (is-@Result-ok @tmp-4-2)) @tmp-4-2 (@Result-ok (or (@Result-value @tmp-4-0) (@Result-value @tmp-4-1) (@Result-value @tmp-4-2))))))))) (@Result-ok true))) (let ((@failure (let ((@tmp-4-0 (let ((@tmp-1-0 (ite (not (List<Int>@get_$_precond0 f 2)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 2))))) (ite (not (is-@Result-ok @tmp-1-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-1-0)) (@Result-ok (not (= (@Result-value @tmp-1-0) 7))))))) (ite (not (is-@Result-ok @tmp-4-0)) @tmp-4-0 (let ((@tmp-4-1 (let ((@tmp-2-0 (ite (not (List<Int>@get_$_precond0 f 0)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 0))))) (ite (not (is-@Result-ok @tmp-2-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-2-0)) (@Result-ok (not (= (@Result-value @tmp-2-0) 10))))))) (ite (not (is-@Result-ok @tmp-4-1)) @tmp-4-1 (let ((@tmp-4-2 (let ((@tmp-3-0 (ite (not (List<Int>@get_$_precond0 f 1)) ((as @Result-err (@Result Int)) @err-other) (@Result-ok (List<Int>@get f 1))))) (ite (not (is-@Result-ok @tmp-3-0)) ((as @Result-err (@Result Bool)) (@Result-etag @tmp-3-0)) (@Result-ok (not (= (@Result-value @tmp-3-0) 2))))))) (ite (not (is-@Result-ok @tmp-4-2)) @tmp-4-2 (@Result-ok (or (@Result-value @tmp-4-0) (@Result-value @tmp-4-1) (@Result-value @tmp-4-2))))))))))) (ite (= @failure (@Result-ok false)) ((as @Result-err (@Result List<Int>)) @err-other) ((as @Result-err (@Result List<Int>)) (@Result-etag @failure))))
            (@Result-ok f)
        )
    )
)
