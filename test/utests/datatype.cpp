...
#define TEST_IT(TYPE, BSQ) { std::u8string result; std::u8string expected; tround(createMetaPathName("datatype"), TYPE, createBSQONPathName("datatype", BSQ), expected, result); checkAndReport(result, expected); }
