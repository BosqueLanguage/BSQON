...
namespace z3
{
    ...
    inline void set_param(char const* param, char const* value)
    {
        Z3_global_param_set(param, value);
    }
    inline void set_param(char const* param, bool value)
    {
    ...
    inline void set_param(char const* param, int value)
    {
        ...
        Z3_global_param_set(param, str.c_str());
    }
    ...
    */
      ...
      public:
        ...
        */
        Z3_error_code check_error() const
        {
            ...
            if(e != Z3_OK && enable_exceptions()) Z3_THROW(exception(Z3_get_error_msg(m_ctx, e)));
            return e;
        }
        ...
        */
        ...
        /**
           ...
           Example: Given a context \c c, <tt>c.array_sort(c.int_sort(), c.bool_sort())</tt> is an array sort from
           integer to Boolean.
        */
         ...
         */
        template <size_t precision> sort fpa_sort();
        /**
        ...
        /**
           ...
           \c cs and \c ts are output parameters. The method stores in \c cs the constants corresponding to the
           enumerated elements, and in \c ts the predicates for testing if terms of the enumeration sort correspond to
           an enumeration.
        */
        ...
        */
        func_decl tuple_sort(char const* name, unsigned n, char const* const* names, sort const* sorts,
        ...
        */
        ...
        func_decl function(char const* name, sort const& d1, sort const& d2, sort const& d3, sort const& d4,
                           sort const& range);
        func_decl function(char const* name, sort const& d1, sort const& d2, sort const& d3, sort const& d4,
                           sort const& d5, sort const& range);
        ...
        template <size_t precision> expr fpa_const(char const* name);
    ...
    template <typename T> class array
    {
      ...
      public:
        ...
        template <typename T2> array(ast_vector_tpl<T2> const& v);
        void resize(unsigned sz)
        {
            m_array.reset(new T[sz]);
            m_size = sz;
        }
        unsigned size() const
        {
    ...
    {
        if(s.kind() == Z3_INT_SYMBOL) out << "k!" << s.to_int();
        else
            out << s.str();
        return out;
    }
    ...
    class param_descrs : public object
    {
      ...
      public:
        param_descrs(context& c, Z3_param_descrs d) : object(c), m_descrs(d)
        {
        ...
        {
            return param_descrs(c, Z3_get_global_param_descrs(c));
        }

        unsigned size()
        {
            return Z3_param_descrs_size(ctx(), m_descrs);
        }
        symbol name(unsigned i)
        {
            return symbol(ctx(), Z3_param_descrs_get_name(ctx(), m_descrs, i));
        }
        Z3_param_kind kind(symbol const& s)
        {
            return Z3_param_descrs_get_kind(ctx(), m_descrs, s);
        }
        ...
        {
            return Z3_param_descrs_to_string(ctx(), m_descrs);
        }
    };

    inline std::ostream& operator<<(std::ostream& out, param_descrs const& d)
    {
    ...
    class params : public object
    {
      ...
      public:
        ...
        params(params const& s) : object(s), m_params(s.m_params)
        {
            Z3_params_inc_ref(ctx(), m_params);
        }
        ~params() override
        ...
        {
            Z3_params_set_symbol(ctx(), m_params, ctx().str_symbol(k), ctx().str_symbol(s));
        }
    ...
    class ast : public object
    {
      ...
      public:
        ...
        ast(context& c, Z3_ast n) : object(c), m_ast(n)
        {
            Z3_inc_ref(ctx(), m_ast);
        }
        ast(ast const& s) : object(s), m_ast(s.m_ast)
        {
            Z3_inc_ref(ctx(), m_ast);
        }
        ~ast() override
        ...
        std::string to_string() const
        {
            return std::string(Z3_ast_to_string(ctx(), m_ast));
        }
    ...
    inline bool eq(ast const& a, ast const& b)
    {
        return Z3_is_eq_ast(a.ctx(), a, b);
    }

    template <typename T> class ast_vector_tpl : public object
    {
      ...
      public:
        ast_vector_tpl(context& c) : object(c)
        {
            init(Z3_mk_ast_vector(c));
        }
        ast_vector_tpl(context& c, Z3_ast_vector v) : object(c)
        {
            init(v);
        }
        ...
        ast_vector_tpl(context& c, ast_vector_tpl const& src) : object(c)
        {
            init(Z3_ast_vector_translate(src.ctx(), src, c));
        }
        ...
        */
        ...
        std::string to_string() const
        {
            return std::string(Z3_ast_vector_to_string(ctx(), m_vector));
        }
    };
    ...
    */
    class sort : public ast
    {
      public:
        ...
        unsigned id() const
        {
            unsigned r = Z3_get_sort_id(ctx(), *this);
            check_error();
            return r;
        }
        ...
        */
        bool is_fpa() const
        {
            return sort_kind() == Z3_FLOATING_POINT_SORT;
        }
        ...
        */
        ...
        {
            assert(is_fpa());
            unsigned r = Z3_fpa_get_ebits(ctx(), *this);
            check_error();
            return r;
        }
        ...
        {
            assert(is_fpa());
            unsigned r = Z3_fpa_get_sbits(ctx(), *this);
            check_error();
            return r;
        }
        /**
        ...
        */
        ...
        {
            return out << Z3_sort_to_string(s.ctx(), Z3_sort(s.m_ast));
        }
    ...
    /**
       \brief Function declaration (aka function definition). It is the signature of interpreted and uninterpreted
       functions in Z3. The basic building block in Z3 is the function application.
    */
    class func_decl : public ast
    {
      public:
        ...
        unsigned id() const
        {
            unsigned r = Z3_get_func_decl_id(ctx(), *this);
            check_error();
            return r;
        }
        ...
        {
            return Z3_get_decl_num_parameters(ctx(), *this);
        }

        func_decl transitive_closure(func_decl const&)
        {
            Z3_func_decl tc = Z3_mk_transitive_closure(ctx(), *this);
            check_error();
            return func_decl(ctx(), tc);
        }
    ...
    /**
       \brief A Z3 expression is used to represent formulas and terms. For Z3, a formula is any expression of sort
       Boolean. Every expression has a sort.
    */
    class expr : public ast
    {
      public:
        ...
        */
        ...
        {
            bool r = Z3_get_numeral_int64(ctx(), m_ast, &i);
            check_error();
            return r;
        }
        bool is_numeral_u64(uint64_t& i) const
        {
            bool r = Z3_get_numeral_uint64(ctx(), m_ast, &i);
            check_error();
            return r;
        }
        bool is_numeral_i(int& i) const
        {
            bool r = Z3_get_numeral_int(ctx(), m_ast, &i);
            check_error();
            return r;
        }
        bool is_numeral_u(unsigned& i) const
        {
            bool r = Z3_get_numeral_uint(ctx(), m_ast, &i);
            check_error();
            return r;
        }
        ...
        {
            if(!is_numeral()) return false;
            d = Z3_get_numeral_double(ctx(), m_ast);
            check_error();
            return true;
        }
        ...
        {
            if(!is_numeral()) return false;
            s = Z3_get_numeral_binary_string(ctx(), m_ast);
            check_error();
            return true;
        }
        ...
        */
        ...
        {
            bool r = Z3_is_well_sorted(ctx(), m_ast);
            check_error();
            return r;
        }
        ...
        */
        ...
        unsigned id() const
        {
            unsigned r = Z3_get_ast_id(ctx(), m_ast);
            check_error();
            return r;
        }
        ...
        */
        ...
        {
            Z3_ast r = Z3_mk_rotate_left(ctx(), i, *this);
            ctx().check_error();
            return expr(ctx(), r);
        }
        expr rotate_right(unsigned i) const
        {
            Z3_ast r = Z3_mk_rotate_right(ctx(), i, *this);
            ctx().check_error();
            return expr(ctx(), r);
        }
        expr repeat(unsigned i) const
        {
            Z3_ast r = Z3_mk_repeat(ctx(), i, *this);
            ctx().check_error();
            return expr(ctx(), r);
        }
        ...
        {
            Z3_ast r = Z3_mk_bit2bool(ctx(), i, *this);
            ctx().check_error();
            return expr(ctx(), r);
        }
        unsigned lo() const
        ...
        */
        ...
        /**
           \brief Return a simplified version of this expression. The parameter \c p is a set of parameters for the Z3
           simplifier.
        */
...
#define _Z3_MK_BIN_(a, b, binop)                                                                                       \
    ...
    inline expr implies(expr const& a, bool b)
    {
        return implies(a, a.ctx().bool_val(b));
    }
    inline expr implies(bool a, expr const& b)
    {
    ...
    inline expr pw(expr const& a, int b)
    {
        return pw(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr pw(int a, expr const& b)
    {
    ...
    inline expr mod(expr const& a, int b)
    {
        return mod(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr mod(int a, expr const& b)
    {
    ...
    inline expr rem(expr const& a, int b)
    {
        return rem(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr rem(int a, expr const& b)
    {
...
#define _Z3_MK_UN_(a, mkun)                                                                                            \
    ...
    inline expr is_int(expr const& e)
    {
...
#undef _Z3_MK_UN_
    ...
    inline expr operator&&(expr const& a, bool b)
    {
        return a && a.ctx().bool_val(b);
    }
    inline expr operator&&(bool a, expr const& b)
    {
    ...
    inline expr operator==(expr const& a, int b)
    {
        assert(a.is_arith() || a.is_bv() || a.is_fpa());
        return a == a.ctx().num_val(b, a.get_sort());
    }
    inline expr operator==(int a, expr const& b)
    {
        assert(b.is_arith() || b.is_bv() || b.is_fpa());
        return b.ctx().num_val(a, b.get_sort()) == b;
    }
    inline expr operator==(expr const& a, double b)
    {
        assert(a.is_fpa());
        return a == a.ctx().fpa_val(b);
    }
    inline expr operator==(double a, expr const& b)
    {
        assert(b.is_fpa());
    ...
    {
        check_context(a, b);
        Z3_ast r = a.is_bool() ? Z3_mk_xor(a.ctx(), a, b) : Z3_mk_bvxor(a.ctx(), a, b);
        a.check_error();
        return expr(a.ctx(), r);
    }
    inline expr operator^(expr const& a, int b)
    ...
    inline expr nand(expr const& a, expr const& b)
    {
        if(a.is_bool()) return !(a && b);
        check_context(a, b);
    ...
    inline expr nor(expr const& a, expr const& b)
    {
        if(a.is_bool()) return !(a || b);
        check_context(a, b);
    ...
    inline expr xnor(expr const& a, expr const& b)
    {
        if(a.is_bool()) return !(a ^ b);
        check_context(a, b);
    ...
    {
        check_context(sgn, exp);
        check_context(exp, sig);
    ...
    */
    ...
    {
        c.check_error();
        assert(Z3_get_ast_kind(c, a) == Z3_APP_AST || Z3_get_ast_kind(c, a) == Z3_NUMERAL_AST ||
               Z3_get_ast_kind(c, a) == Z3_VAR_AST || Z3_get_ast_kind(c, a) == Z3_QUANTIFIER_AST);
        return expr(c, a);
    }
    ...
    */
    inline expr sle(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvsle(a.ctx(), a, b));
    }
    inline expr sle(expr const& a, int b)
    {
        return sle(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr sle(int a, expr const& b)
    {
    ...
    */
    inline expr slt(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvslt(a.ctx(), a, b));
    }
    inline expr slt(expr const& a, int b)
    {
        return slt(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr slt(int a, expr const& b)
    {
    ...
    */
    inline expr sge(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvsge(a.ctx(), a, b));
    }
    inline expr sge(expr const& a, int b)
    {
        return sge(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr sge(int a, expr const& b)
    {
    ...
    */
    inline expr sgt(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvsgt(a.ctx(), a, b));
    }
    inline expr sgt(expr const& a, int b)
    {
        return sgt(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr sgt(int a, expr const& b)
    {
    ...
    */
    inline expr ule(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvule(a.ctx(), a, b));
    }
    inline expr ule(expr const& a, int b)
    {
        return ule(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr ule(int a, expr const& b)
    {
    ...
    */
    inline expr ult(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvult(a.ctx(), a, b));
    }
    inline expr ult(expr const& a, int b)
    {
        return ult(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr ult(int a, expr const& b)
    {
    ...
    */
    inline expr uge(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvuge(a.ctx(), a, b));
    }
    inline expr uge(expr const& a, int b)
    {
        return uge(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr uge(int a, expr const& b)
    {
    ...
    */
    inline expr ugt(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvugt(a.ctx(), a, b));
    }
    inline expr ugt(expr const& a, int b)
    {
        return ugt(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr ugt(int a, expr const& b)
    {
    ...
    */
    inline expr udiv(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvudiv(a.ctx(), a, b));
    }
    inline expr udiv(expr const& a, int b)
    {
        return udiv(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr udiv(int a, expr const& b)
    {
    ...
    */
    inline expr srem(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvsrem(a.ctx(), a, b));
    }
    inline expr srem(expr const& a, int b)
    {
        return srem(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr srem(int a, expr const& b)
    {
    ...
    */
    inline expr smod(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvsmod(a.ctx(), a, b));
    }
    inline expr smod(expr const& a, int b)
    {
        return smod(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr smod(int a, expr const& b)
    {
    ...
    */
    inline expr urem(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvurem(a.ctx(), a, b));
    }
    inline expr urem(expr const& a, int b)
    {
        return urem(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr urem(int a, expr const& b)
    {
    ...
    */
    inline expr shl(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvshl(a.ctx(), a, b));
    }
    inline expr shl(expr const& a, int b)
    {
        return shl(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr shl(int a, expr const& b)
    {
    ...
    */
    inline expr lshr(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvlshr(a.ctx(), a, b));
    }
    inline expr lshr(expr const& a, int b)
    {
        return lshr(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr lshr(int a, expr const& b)
    {
    ...
    */
    inline expr ashr(expr const& a, expr const& b)
    {
        return to_expr(a.ctx(), Z3_mk_bvashr(a.ctx(), a, b));
    }
    inline expr ashr(expr const& a, int b)
    {
        return ashr(a, a.ctx().num_val(b, a.get_sort()));
    }
    inline expr ashr(int a, expr const& b)
    {
        return ashr(b.ctx().num_val(a, b.get_sort()), b);
    }

    /**
       \brief Extend the given bit-vector with zeros to the (unsigned) equivalent bitvector of size m+i, where m is the
       size of the given bit-vector.
    */
    inline expr zext(expr const& a, unsigned i)
    {
    ...
    */
    inline expr bv2int(expr const& a, bool is_signed)
    {
        Z3_ast r = Z3_mk_bv2int(a.ctx(), a, is_signed);
        a.check_error();
        return expr(a.ctx(), r);
    }
    inline expr int2bv(unsigned n, expr const& a)
    {
        Z3_ast r = Z3_mk_int2bv(a.ctx(), n, a);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    */
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvadd_no_overflow(a.ctx(), a, b, is_signed);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvadd_no_underflow(a.ctx(), a, b);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvsub_no_overflow(a.ctx(), a, b);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvsub_no_underflow(a.ctx(), a, b, is_signed);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvsdiv_no_overflow(a.ctx(), a, b);
        a.check_error();
        return expr(a.ctx(), r);
    }
    inline expr bvneg_no_overflow(expr const& a)
    {
        Z3_ast r = Z3_mk_bvneg_no_overflow(a.ctx(), a);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvmul_no_overflow(a.ctx(), a, b, is_signed);
        a.check_error();
        return expr(a.ctx(), r);
    }
    ...
    {
        check_context(a, b);
        Z3_ast r = Z3_mk_bvmul_no_underflow(a.ctx(), a, b);
        a.check_error();
        return expr(a.ctx(), r);
    }

    /**
       \brief Sign-extend of the given bit-vector to the (signed) equivalent bitvector of size m+i, where m is the size
       of the given bit-vector.
    */
    inline expr sext(expr const& a, unsigned i)
    {
    ...
    template <> class cast_ast<expr>
    {
      public:
        ...
        {
            assert(Z3_get_ast_kind(c, a) == Z3_NUMERAL_AST || Z3_get_ast_kind(c, a) == Z3_APP_AST ||
                   Z3_get_ast_kind(c, a) == Z3_QUANTIFIER_AST || Z3_get_ast_kind(c, a) == Z3_VAR_AST);
            return expr(c, a);
        }
    };
    ...
    inline expr lambda(expr const& x, expr const& b)
    {
        check_context(x, b);
        Z3_app vars[] = {(Z3_app)x};
        Z3_ast r = Z3_mk_lambda_const(b.ctx(), 1, vars, b);
        b.check_error();
        return expr(b.ctx(), r);
    }
    inline expr lambda(expr const& x1, expr const& x2, expr const& b)
    {
        ...
        check_context(x2, b);
        Z3_app vars[] = {(Z3_app)x1, (Z3_app)x2};
        Z3_ast r = Z3_mk_lambda_const(b.ctx(), 2, vars, b);
        b.check_error();
        return expr(b.ctx(), r);
    }
    inline expr lambda(expr const& x1, expr const& x2, expr const& x3, expr const& b)
    {
        ...
        check_context(x3, b);
        Z3_app vars[] = {(Z3_app)x1, (Z3_app)x2, (Z3_app)x3};
        Z3_ast r = Z3_mk_lambda_const(b.ctx(), 3, vars, b);
        b.check_error();
        return expr(b.ctx(), r);
    }
    inline expr lambda(expr const& x1, expr const& x2, expr const& x3, expr const& x4, expr const& b)
    {
        ...
        check_context(x4, b);
        Z3_app vars[] = {(Z3_app)x1, (Z3_app)x2, (Z3_app)x3, (Z3_app)x4};
        Z3_ast r = Z3_mk_lambda_const(b.ctx(), 4, vars, b);
        b.check_error();
        return expr(b.ctx(), r);
    }
    ...
    {
        array<Z3_app> vars(xs);
        Z3_ast r = Z3_mk_lambda_const(b.ctx(), vars.size(), vars.ptr(), b);
        b.check_error();
        return expr(b.ctx(), r);
    }
    ...
    {
        if(args.empty()) return args.ctx().bool_val(false);
        expr r = args[0u];
    ...
    class func_entry : public object
    {
      ...
      public:
        func_entry(context& c, Z3_func_entry e) : object(c)
        {
            init(e);
        }
        func_entry(func_entry const& s) : object(s)
        {
            init(s.m_entry);
        }
        ~func_entry() override
    ...
    class func_interp : public object
    {
      ...
      public:
        func_interp(context& c, Z3_func_interp e) : object(c)
        {
            init(e);
        }
        func_interp(func_interp const& s) : object(s)
        {
            init(s.m_interp);
        }
    ...
    class model : public object
    {
      ...
      public:
        ...
        model(context& c, Z3_model m) : object(c)
        {
            init(m);
        }
        model(model const& s) : object(s)
        {
            init(s.m_model);
        }
        model(model& src, context& dst, translate) : object(dst)
        {
            init(Z3_model_translate(src.ctx(), src, dst));
        }
        ~model() override
        {
        ...
        expr eval(expr const& n, bool model_completion = false) const
        {
            ...
            check_error();
            if(status == false && ctx().enable_exceptions()) Z3_THROW(exception("failed to evaluate expression"));
            return expr(ctx(), r);
        }
        ...
        std::string to_string() const
        {
            return m_model ? std::string(Z3_model_to_string(ctx(), m_model)) : "null";
        }
    };
    ...
    class stats : public object
    {
      ...
      public:
        ...
        stats(context& c, Z3_stats e) : object(c)
        {
            init(e);
        }
        stats(stats const& s) : object(s)
        {
            init(s.m_stats);
        }
        ~stats() override
        ...
        {
            bool r = Z3_stats_is_uint(ctx(), m_stats, i);
            check_error();
            return r;
        }
        bool is_double(unsigned i) const
        {
            bool r = Z3_stats_is_double(ctx(), m_stats, i);
            check_error();
            return r;
        }
    ...
    */
    class parameter
    {
      ...
      public:
        ...
        expr get_expr() const
        {
            Z3_ast a = Z3_get_decl_ast_parameter(ctx(), m_decl, m_index);
            check_error();
            return expr(ctx(), a);
        }
        sort get_sort() const
        {
            Z3_sort s = Z3_get_decl_sort_parameter(ctx(), m_decl, m_index);
            check_error();
            return sort(ctx(), s);
        }
        func_decl get_decl() const
        {
            Z3_func_decl f = Z3_get_decl_func_decl_parameter(ctx(), m_decl, m_index);
            check_error();
            return func_decl(ctx(), f);
        }
        symbol get_symbol() const
        {
            Z3_symbol s = Z3_get_decl_symbol_parameter(ctx(), m_decl, m_index);
            check_error();
            return symbol(ctx(), s);
        }
        std::string get_rational() const
        {
            Z3_string s = Z3_get_decl_rational_parameter(ctx(), m_decl, m_index);
            check_error();
            return s;
        }
        double get_double() const
        {
            double d = Z3_get_decl_double_parameter(ctx(), m_decl, m_index);
            check_error();
            return d;
        }
        int get_int() const
        {
            int i = Z3_get_decl_int_parameter(ctx(), m_decl, m_index);
            check_error();
            return i;
        }
    };
    ...
    class solver : public object
    {
      ...
      public:
        ...
        solver(context& c) : object(c)
        {
            init(Z3_mk_solver(c));
            check_error();
        }
        solver(context& c, simple) : object(c)
        {
            init(Z3_mk_simple_solver(c));
            check_error();
        }
        solver(context& c, Z3_solver s) : object(c)
        {
            init(s);
        }
        solver(context& c, char const* logic) : object(c)
        {
            init(Z3_mk_solver_for_logic(c, c.str_symbol(logic)));
            check_error();
        }
        ...
        solver(solver const& s) : object(s)
        {
            init(s.m_solver);
        }
        ...
        */
        ...
        {
            Z3_solver_from_file(ctx(), m_solver, file);
            ctx().check_parser_error();
        }
        void from_string(char const* s)
        {
            Z3_solver_from_string(ctx(), m_solver, s);
            ctx().check_parser_error();
        }
        ...
        {
            Z3_ast_vector r = Z3_solver_get_non_units(ctx(), m_solver);
            check_error();
            return expr_vector(ctx(), r);
        }
        expr_vector units() const
        {
            Z3_ast_vector r = Z3_solver_get_units(ctx(), m_solver);
            check_error();
            return expr_vector(ctx(), r);
        }
        ...
        std::string to_smt2(char const* status = "unknown")
        {
            ...
            return std::string(Z3_benchmark_to_smtlib_string(ctx(), "", "", status, "", sz, fmls, fml));
        }
        ...
        class cube_iterator
        {
          ...
          public:
            cube_iterator(solver& s, expr_vector& vars, unsigned& cutoff, bool end)
                : m_solver(s), m_cutoff(cutoff), m_vars(vars), m_cube(s.ctx()), m_end(end), m_empty(false)
            {
                if(!m_end) {
                    inc();
                }
        ...
        class cube_generator
        {
          ...
          public:
            cube_generator(solver& s)
                : m_solver(s), m_cutoff(0xFFFFFFFF), m_default_vars(s.ctx()), m_vars(m_default_vars)
            {
            }

            cube_generator(solver& s, expr_vector& vars)
                : m_solver(s), m_cutoff(0xFFFFFFFF), m_default_vars(s.ctx()), m_vars(vars)
            {
            }

            cube_iterator begin()
            {
                return cube_iterator(m_solver, m_vars, m_cutoff, false);
            }
            cube_iterator end()
            {
                return cube_iterator(m_solver, m_vars, m_cutoff, true);
            }
    ...
    class goal : public object
    {
      ...
      public:
        ...
        goal(context& c, Z3_goal s) : object(c)
        {
            init(s);
        }
        goal(goal const& s) : object(s)
        {
            init(s.m_goal);
        }
        ~goal() override
        ...
        {
            return Z3_goal_inconsistent(ctx(), m_goal);
        }
        ...
        {
            return Z3_goal_is_decided_sat(ctx(), m_goal);
        }
        bool is_decided_unsat() const
        {
            return Z3_goal_is_decided_unsat(ctx(), m_goal);
        }
        ...
        {
            unsigned n = size();
            if(n == 0) return ctx().bool_val(true);
            else if(n == 1)
                return operator[](0u);
            else {
                array<Z3_ast> args(n);
        ...
        std::string dimacs(bool include_names = true) const
        {
            return std::string(Z3_goal_to_dimacs_string(ctx(), m_goal, include_names));
        }
    ...
    class apply_result : public object
    {
      ...
      public:
        apply_result(context& c, Z3_apply_result s) : object(c)
        {
            init(s);
        }
        apply_result(apply_result const& s) : object(s)
        {
    ...
    class tactic : public object
    {
      ...
      public:
        ...
        tactic(context& c, Z3_tactic s) : object(c)
        {
            init(s);
        }
        tactic(tactic const& s) : object(s)
        {
            init(s.m_tactic);
        }
        ~tactic() override
        ...
        param_descrs get_param_descrs()
        {
            return param_descrs(ctx(), Z3_tactic_get_param_descrs(ctx(), m_tactic));
        }
    };
    ...
    class simplifier : public object
    {
      ...
      public:
        simplifier(context& c, char const* name) : object(c)
        {
            Z3_simplifier r = Z3_mk_simplifier(c, name);
            check_error();
            init(r);
        }
        simplifier(context& c, Z3_simplifier s) : object(c)
        {
            init(s);
        }
        simplifier(simplifier const& s) : object(s)
        {
            init(s.m_simplifier);
        }
        ~simplifier() override
        ...
        std::string help() const
        {
            char const* r = Z3_simplifier_get_help(ctx(), m_simplifier);
            check_error();
            return r;
        }
        ...
        param_descrs get_param_descrs()
        {
            return param_descrs(ctx(), Z3_simplifier_get_param_descrs(ctx(), m_simplifier));
        }
    };

    inline solver::solver(solver const& s, simplifier const& simp) : object(s)
    {
        init(Z3_solver_add_simplifier(s.ctx(), s, simp));
    }
    ...
    class probe : public object
    {
      ...
      public:
        ...
        probe(context& c, Z3_probe s) : object(c)
        {
            init(s);
        }
        probe(probe const& s) : object(s)
        {
            init(s.m_probe);
        }
        ~probe() override
    ...
    inline probe operator<=(probe const& p1, double p2)
    {
        return p1 <= probe(p1.ctx(), p2);
    }
    inline probe operator<=(double p1, probe const& p2)
    {
    ...
    class optimize : public object
    {
      ...
      public:
        ...
        optimize(context& c, optimize& src) : object(c)
        {
            ...
            for(expr_vector::iterator it = v.begin(); it != v.end(); ++it)
                minimize(*it);
        }
        ...
        {
            for(expr_vector::iterator it = es.begin(); it != es.end(); ++it)
                add(*it);
        }
        ...
        check_result check()
        {
            Z3_lbool r = Z3_optimize_check(ctx(), m_opt, 0, 0);
            check_error();
            return to_check_result(r);
        }
        ...
        expr_vector unsat_core() const
        {
            Z3_ast_vector r = Z3_optimize_get_unsat_core(ctx(), m_opt);
            check_error();
            return expr_vector(ctx(), r);
        }
        void set(params const& p)
    ...
    class fixedpoint : public object
    {
      ...
      public:
        ...
        {
            return Z3_fixedpoint_get_reason_unknown(ctx(), m_fp);
        }
        ...
        {
            Z3_fixedpoint_register_relation(ctx(), m_fp, p);
        }
        expr_vector assertions() const
        {
        ...
        std::string help() const
        {
            return Z3_fixedpoint_get_help(ctx(), m_fp);
        }
        param_descrs get_param_descrs()
        {
            return param_descrs(ctx(), Z3_fixedpoint_get_param_descrs(ctx(), m_fp));
        }
        std::string to_string()
        {
            return Z3_fixedpoint_to_string(ctx(), m_fp, 0, 0);
        }
    ...
    inline sort context::char_sort()
    {
        Z3_sort s = Z3_mk_char_sort(m_ctx);
        check_error();
        return sort(*this, s);
    }
    ...
    inline sort context::fpa_sort(unsigned ebits, unsigned sbits)
    {
        Z3_sort s = Z3_mk_fpa_sort(m_ctx, ebits, sbits);
        check_error();
        return sort(*this, s);
    }

    template <> inline sort context::fpa_sort<16>()
    {
        return fpa_sort(5, 11);
    }

    template <> inline sort context::fpa_sort<32>()
    {
        return fpa_sort(8, 24);
    }

    template <> inline sort context::fpa_sort<64>()
    {
        return fpa_sort(11, 53);
    }

    template <> inline sort context::fpa_sort<128>()
    {
        return fpa_sort(15, 113);
    }

    inline sort context::fpa_rounding_mode_sort()
    {
        Z3_sort r = Z3_mk_fpa_rounding_mode_sort(m_ctx);
        check_error();
        return sort(*this, r);
    }
    ...
    {
        array<Z3_sort> dom(d);
        Z3_sort s = Z3_mk_array_sort_n(m_ctx, dom.size(), dom.ptr(), r);
        check_error();
        return sort(*this, s);
    }
    inline sort context::enumeration_sort(char const* name, unsigned n, char const* const* enum_names,
                                          func_decl_vector& cs, func_decl_vector& ts)
    {
        array<Z3_symbol> _enum_names(n);
        for(unsigned i = 0; i < n; i++) {
            _enum_names[i] = Z3_mk_string_symbol(*this, enum_names[i]);
        }
    ...
    inline func_decl context::tuple_sort(char const* name, unsigned n, char const* const* names, sort const* sorts,
                                         func_decl_vector& projs)
    {
        array<Z3_symbol> _names(n);
        array<Z3_sort> _sorts(n);
        for(unsigned i = 0; i < n; i++) {
            _names[i] = Z3_mk_string_symbol(*this, names[i]);
            _sorts[i] = sorts[i];
        }
        ...
        Z3_func_decl tuple;
        sort _ignore_s =
            to_sort(*this, Z3_mk_tuple_sort(*this, _name, n, _names.ptr(), _sorts.ptr(), &tuple, _projs.ptr()));
        check_error();
        for(unsigned i = 0; i < n; i++) {
            projs.push_back(func_decl(*this, _projs[i]));
        }
    ...
    class constructors
    {
      ...
      public:
        ...
        void add(symbol const& name, symbol const& rec, unsigned n, symbol const* names, sort const* fields)
        {
            ...
            array<Z3_symbol> _names(n);
            for(unsigned i = 0; i < n; ++i)
                sorts[i] = fields[i], _names[i] = names[i];
        ...
        void query(unsigned i, func_decl& constructor, func_decl& test, func_decl_vector& accs)
        {
            ...
            accs.resize(0);
            Z3_query_constructor(ctx, cons[i], num_fields[i], &_constructor, &_test, accessors.ptr());
    ...
    inline sort_vector context::datatypes(unsigned n, symbol const* names, constructor_list* const* cons)
    {
    ...
    inline func_decl context::function(char const* name, sort const& d1, sort const& d2, sort const& d3,
                                       sort const& range)
    {
        check_context(d1, range);
        check_context(d2, range);
    ...
    {
        check_context(f, args);
        check_context(f, body);
    ...
    inline expr context::constant(char const* name, sort const& s)
    {
    ...
    inline expr context::bool_const(char const* name)
    {
        return constant(name, bool_sort());
    }
    inline expr context::int_const(char const* name)
    {
        return constant(name, int_sort());
    }
    inline expr context::real_const(char const* name)
    {
        return constant(name, real_sort());
    }
    inline expr context::string_const(char const* name)
    {
        return constant(name, string_sort());
    }
    inline expr context::bv_const(char const* name, unsigned sz)
    {
        return constant(name, bv_sort(sz));
    }
    inline expr context::fpa_const(char const* name, unsigned ebits, unsigned sbits)
    {
        return constant(name, fpa_sort(ebits, sbits));
    }

    template <size_t precision> inline expr context::fpa_const(char const* name)
    {
        return constant(name, fpa_sort<precision>());
    }

    inline void context::set_rounding_mode(rounding_mode rm)
    {
        m_rounding_mode = rm;
    }
    ...
    inline expr context::fpa_rounding_mode()
    {
        ...
        case RNA:
            return expr(*this, Z3_mk_fpa_rna(m_ctx));
        case RNE:
            return expr(*this, Z3_mk_fpa_rne(m_ctx));
        case RTP:
            return expr(*this, Z3_mk_fpa_rtp(m_ctx));
        case RTN:
            return expr(*this, Z3_mk_fpa_rtn(m_ctx));
        case RTZ:
            return expr(*this, Z3_mk_fpa_rtz(m_ctx));
        default:
            return expr(*this);
        }
    }
    ...
    inline expr context::int_val(int64_t n)
    {
        Z3_ast r = Z3_mk_int64(m_ctx, n, int_sort());
        check_error();
        return expr(*this, r);
    }
    inline expr context::int_val(uint64_t n)
    {
    ...
    inline expr context::real_val(int64_t n, int64_t d)
    {
        Z3_ast r = Z3_mk_real_int64(m_ctx, n, d);
        check_error();
        return expr(*this, r);
    }
    ...
    inline expr context::real_val(int64_t n)
    {
        Z3_ast r = Z3_mk_int64(m_ctx, n, real_sort());
        check_error();
        return expr(*this, r);
    }
    inline expr context::real_val(uint64_t n)
    {
    ...
    {
        sort s = bv_sort(sz);
        Z3_ast r = Z3_mk_unsigned_int(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::bv_val(int64_t n, unsigned sz)
    {
        sort s = bv_sort(sz);
        Z3_ast r = Z3_mk_int64(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::bv_val(uint64_t n, unsigned sz)
    {
        sort s = bv_sort(sz);
        Z3_ast r = Z3_mk_unsigned_int64(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    ...
    {
        sort s = bv_sort(sz);
        Z3_ast r = Z3_mk_numeral(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::bv_val(unsigned n, bool const* bits)
    {
        ...
        for(unsigned i = 0; i < n; ++i)
            _bits[i] = bits[i] ? 1 : 0;
        Z3_ast r = Z3_mk_bv_numeral(m_ctx, n, _bits.ptr());
        check_error();
        return expr(*this, r);
    }

    inline expr context::fpa_val(double n)
    {
        sort s = fpa_sort<64>();
        Z3_ast r = Z3_mk_fpa_numeral_double(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::fpa_val(float n)
    {
        sort s = fpa_sort<32>();
        Z3_ast r = Z3_mk_fpa_numeral_float(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::fpa_nan(sort const& s)
    {
        Z3_ast r = Z3_mk_fpa_nan(m_ctx, s);
        check_error();
        return expr(*this, r);
    }
    inline expr context::fpa_inf(sort const& s, bool sgn)
    {
        Z3_ast r = Z3_mk_fpa_inf(m_ctx, s, sgn);
        check_error();
        return expr(*this, r);
    }

    inline expr context::string_val(char const* s, unsigned n)
    {
        Z3_ast r = Z3_mk_lstring(m_ctx, n, s);
        check_error();
        return expr(*this, r);
    }
    ...
    inline expr context::string_val(std::u32string const& s)
    {
        Z3_ast r = Z3_mk_u32string(m_ctx, (unsigned)s.size(), (unsigned const*)s.c_str());
        check_error();
        return expr(*this, r);
    }
    ...
    inline expr func_decl::operator()(expr const& a1, expr const& a2, expr const& a3, expr const& a4,
                                      expr const& a5) const
    {
        check_context(*this, a1);
        check_context(*this, a2);
    ...
    inline func_decl function(char const* name, sort const& d1, sort const& d2, sort const& d3, sort const& d4,
                              sort const& range)
    {
...
#define MK_EXPR2(_fn, _arg1, _arg2)                                                                                    \
    ...
    inline expr_vector context::parse_string(char const* s, sort_vector const& sorts, func_decl_vector const& decls)
    {
        ...
        Z3_ast_vector r = Z3_parse_smtlib2_string(*this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
    ...
    inline expr_vector context::parse_file(char const* s, sort_vector const& sorts, func_decl_vector const& decls)
    {
        ...
        Z3_ast_vector r = Z3_parse_smtlib2_file(*this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
                                                decl_names.ptr(), decls1.ptr());
        check_error();
        return expr_vector(*this, r);
    }
    ...
    typedef std::function<void(expr const& proof, std::vector<unsigned> const& deps, expr_vector const& clause)>
        on_clause_eh_t;
    ...
    class user_propagator_base
    {
        ...
        struct scoped_cb
        {
            ...
            ~scoped_cb()
            {
                if(--p.m_callbackNesting == 0) p.cb = nullptr;
            }
        };
      ...
      public:
        ...
        */
        ...
        void register_fixed()
        {
            m_fixed_eh = [this](expr const& id, expr const& e) { fixed(id, e); };
            if(s) {
                Z3_solver_propagate_fixed(ctx(), *s, fixed_eh);
            }
        }
        ...
        void register_eq()
        {
            m_eq_eh = [this](expr const& x, expr const& y) { eq(x, y); };
            if(s) {
                Z3_solver_propagate_eq(ctx(), *s, eq_eh);
            }
        }
        ...
        */
        ...
        {
            m_created_eh = [this](expr const& e) { created(e); };
            if(s) {
                Z3_solver_propagate_created(ctx(), *s, created_eh);
            }
        }
        ...
        {
            m_decide_eh = [this](expr val, unsigned bit, bool is_pos) { decide(val, bit, is_pos); };
            if(s) {
                Z3_solver_propagate_decide(ctx(), *s, decide_eh);
            }
        }
        ...
        void add(expr const& e)
        {
            if(cb) Z3_solver_propagate_register_cb(ctx(), cb, e);
            else if(s)
        ...
        void conflict(expr_vector const& fixed, expr_vector const& lhs, expr_vector const& rhs)
        {
            ...
            Z3_solver_propagate_consequence(ctx(), cb, fixed.size(), _fixed.ptr(), lhs.size(), _lhs.ptr(), _rhs.ptr(),
                                            conseq);
        }
        ...
        bool propagate(expr_vector const& fixed, expr_vector const& lhs, expr_vector const& rhs, expr const& conseq)
        {
            ...
            return Z3_solver_propagate_consequence(ctx(), cb, _fixed.size(), _fixed.ptr(), lhs.size(), _lhs.ptr(),
                                                   _rhs.ptr(), conseq);
        }
    };
